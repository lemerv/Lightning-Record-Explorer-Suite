...
import HierarchyCard from "c/lresHierarchyCard";
import {
  createDataTransfer,
  flushPromises
} from "../../lresTestUtils/lresTestUtils";

describe("c-lres-hierarchy-card", () => {
  afterEach(() => {
  ...
  const buildComponent = (props = {}) => {
    const element = createElement("c-lres-hierarchy-card", {
      is: HierarchyCard
    });
  ...
  describe("Template Rendering", () => {
    ...
    it("renders card with emoji when titleEmoji is provided", () => {
      ...
      const emojiSpan = element.shadowRoot.querySelector(
        ".hierarchy-field_emoji"
      );
